<?php
    ...
    function existeLogin($nome)
    {
    $retorno = selectRegistros("select * from login where lower(dslogin)='" . strtolower($nome) . "'");
    ...
    function AtualizarLogin($dslogin, $idaluno)
    {
        $sql = 'update login set idaluno = '.$idaluno.' where dslogin ="'.$dslogin.'"';
        return updateRegistro($sql); 
    }
?>